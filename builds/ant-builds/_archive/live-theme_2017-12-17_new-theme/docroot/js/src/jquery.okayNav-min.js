...
! function(e) {
    ...
    n.prototype = {
        ...
        getVisibleItemCount: function() {
            return e(".okayNavCollapse", self.nav_visible).length
        },
        getHiddenItemCount: function() {
            return e(".okayNavCollapse", self.nav_invisible).length
        },
        recalcNav: function() {
        ...
        _collapseNavItem: function() {
            var n = e(".okayNavCollapse:last-child", self.nav_visible);
        ...
        _expandNavItem: function() {
            var n = e(".okayNavCollapse:first-child", self.nav_invisible);
            self.document.trigger("okayNav:expandItem", n), n.detach().appendTo(self.nav_visible), self.options.itemDisplayed.call()
        },
        _expandAllItems: function() {
            e(".okayNavCollapse", self.nav_invisible).detach().appendTo(self.nav_visible), self.options.itemDisplayed.call()
        },
        _collapseAllItems: function() {
            e(".okayNavCollapse", self.nav_visible).detach().appendTo(self.nav_invisible), self.options.itemHidden.call()
        },
        destroy: function() {
            e(".okayNavCollapse", self.nav_invisible).appendTo(self.nav_visible), self.nav_invisible.remove(), self.nav_visible.removeClass("okayNav__nav--visible"), self.toggle_icon.remove(), self.document.unbind(".okayNav"), self.window.unbind(".okayNav")
        }
    }, e.fn[i] = function(s) {
        var l = arguments;
